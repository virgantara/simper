...
class Inmail extends CI_Controller {
    ...
    public function index() {
        ...
        $this->output->set_title(lang('recap') . ' ' . lang('inmail'));
        $this->load->view('inmail/list', $this->data);
    }
    ...
    public function get_list() {
        ...
        $output['data'] = array();
        $datas = $this->inmail->get_all($date_start, $date_end,$start, $length, $order);
        if ($datas) {
        ...
        $output['draw'] = $draw++;
        $output['recordsTotal'] = $this->inmail->count_all($date_start, $date_end);
    ...
    public function prints() {
        ...
        $data['mails'] = $this->inmail->get_all($date_start, $date_end,'', '', false);
        $this->load->view('inmail/print', $data);
    }
